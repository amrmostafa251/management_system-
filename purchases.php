...
// SQL query to retrieve data from the "purchases" table
$query = "SELECT item_name, number, price, sale_price FROM purchases";
...
<body>
    ...
    <table border="1">
        ...
        <form method="POST" action="purchases_search_results.php">
        <!-- Year dropdown list -->
