...
<table border="1">
    ...
    <tbody>
        ...
        if (isset($_POST['year']) && isset($_POST['month']) && isset($_POST['day'])) {
            ...
            $query = "SELECT item_name, number, sale_price FROM sales WHERE year = :year AND month = :month AND day = :day ";
            ...
            // SQL query to retrieve data from the "sales" table with the applied filter
            $query = "SELECT item_name, number, sale_price FROM sales WHERE year = :year AND month = :month  ";
            $stmt = $conn->prepare($query);
            $stmt->bindParam(':year', $year, PDO::PARAM_STR);
            $stmt->bindParam(':month', $month, PDO::PARAM_STR);
            $stmt->execute();
